 ...
 *
 * @see org.luceehibernate.cfg.Configuration
 *
 * @author Gavin King
...
public interface SessionFactory extends Referenceable, Serializable {
	 ...
	 * configured {@link org.luceehibernate.connection.ConnectionProvider} as needed
	 ...
	 * @throws HibernateException Indicates a peroblem opening the session; pretty rare here.
	 */
	public org.luceehibernate.classic.Session openSession(Interceptor interceptor) throws HibernateException;
	 ...
	 * {@link org.luceehibernate.connection.ConnectionProvider} instead as a highly
	 ...
	 * @return The created session.
	 */
	public org.luceehibernate.classic.Session openSession(Connection connection, Interceptor interceptor);

	/**
	 * Obtains the current session.  The definition of what exactly "current"
	 * means controlled by the {@link org.luceehibernate.context.CurrentSessionContext} impl configured
	 * for use.
	 * <p/>
	 * Note that for backwards compatibility, if a {@link org.luceehibernate.context.CurrentSessionContext}
	 * is not configured but a JTA {@link org.luceehibernate.transaction.TransactionManagerLookup}
	 * is configured this will default to the {@link org.luceehibernate.context.JTASessionContext}
	 * impl.
	 *
