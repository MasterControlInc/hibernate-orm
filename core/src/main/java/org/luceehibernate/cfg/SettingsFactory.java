...
import org.luceehibernate.engine.jdbc.JdbcSupport;
import org.luceehibernate.engine.jdbc.JdbcSupportLoader;
import org.luceehibernate.bytecode.BytecodeProvider;
import org.luceehibernate.cache.QueryCacheFactory;
import org.luceehibernate.cache.RegionFactory;
import org.luceehibernate.cache.impl.NoCachingRegionFactory;
...
import org.luceehibernate.connection.ConnectionProviderFactory;
import org.luceehibernate.dialect.Dialect;
import org.luceehibernate.dialect.resolver.DialectFactory;
import org.luceehibernate.exception.SQLExceptionConverter;
import org.luceehibernate.exception.SQLExceptionConverterFactory;
import org.luceehibernate.hql.QueryTranslatorFactory;
import org.luceehibernate.jdbc.BatcherFactory;
import org.luceehibernate.jdbc.BatchingBatcherFactory;
import org.luceehibernate.jdbc.NonBatchingBatcherFactory;
import org.luceehibernate.jdbc.util.SQLStatementLogger;
import org.luceehibernate.transaction.TransactionFactory;
import org.luceehibernate.transaction.TransactionFactoryFactory;
import org.luceehibernate.transaction.TransactionManagerLookup;
import org.luceehibernate.transaction.TransactionManagerLookupFactory;
...
//		settings.setBytecodeProvider( bytecodeProvider );
	...
	protected BytecodeProvider buildBytecodeProvider(String providerName) {
		if ( "javassist".equals( providerName ) ) {
			return new org.luceehibernate.bytecode.javassist.BytecodeProviderImpl();
		}
		else if ( "cglib".equals( providerName ) ) {
			return new org.luceehibernate.bytecode.cglib.BytecodeProviderImpl();
		}
		else {
	...
	protected QueryCacheFactory createQueryCacheFactory(Properties properties) {
		String queryCacheFactoryClassName = PropertiesHelper.getString(
				Environment.QUERY_CACHE_FACTORY, properties, "org.luceehibernate.cache.StandardQueryCacheFactory"
		);
	...
	protected QueryTranslatorFactory createQueryTranslatorFactory(Properties properties) {
		String className = PropertiesHelper.getString(
				Environment.QUERY_TRANSLATOR, properties, "org.luceehibernate.hql.ast.ASTQueryTranslatorFactory"
		);
