 ...
 * New code should use <tt>org.luceehibernate.Session</tt>.
 * @author Gavin King
 */
public interface Session extends org.luceehibernate.Session {
	 ...
	 *
	 * @deprecated use {@link org.luceehibernate.Session#merge(Object)}
	 *
	 ...
	 * does not become associated with the session.
	 *
	 * @deprecated use {@link org.luceehibernate.Session#merge(String, Object)}
	 *
	 * @param object a transient instance with state to be copied
	 * @return an updated persistent instance
	 */
	 ...
	 * @see org.luceehibernate.Hibernate for access to <tt>Type</tt> instances
	 * @return a distinct list of instances (or arrays of instances)
	 * @throws HibernateException
	 */
