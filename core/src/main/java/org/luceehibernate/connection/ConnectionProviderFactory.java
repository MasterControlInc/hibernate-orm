 ...
 */
package org.luceehibernate.connection;
...
public final class ConnectionProviderFactory {
	 ...
	 *
	 * @param properties Properties being used to build the {@link org.luceehibernate.SessionFactory}.
	...
	public static ConnectionProvider newConnectionProvider(Properties properties, Map connectionProviderInjectionData)
		...
		if ( providerClass != null ) {
			...
			connections = initializeConnectionProviderFromConfig("org.luceehibernate.connection.C3P0ConnectionProvider");
		}
	...
	private static boolean c3p0ProviderPresent() {
		try {
			ReflectHelper.classForName( "org.luceehibernate.connection.C3P0ConnectionProvider" );
		}
		catch ( ClassNotFoundException e ) {
			log.warn( "c3p0 properties is specificed, but could not find org.luceehibernate.connection.C3P0ConnectionProvider from the classpath, " +
