...
public class UserSuppliedConnectionProvider implements ConnectionProvider {
	...
	/**
	 * @see org.luceehibernate.connection.ConnectionProvider#configure(Properties)
	 */
	...
	/**
	 * @see org.luceehibernate.connection.ConnectionProvider#getConnection()
	 */
	...
	/**
	 * @see org.luceehibernate.connection.ConnectionProvider#closeConnection(Connection)
	 */
