 ...
 *
 */
package org.luceehibernate.context;
...
import org.luceehibernate.classic.Session;
 ...
 * after the {@link org.luceehibernate.Transaction} associated with that session
...
public class ThreadLocalSessionContext implements CurrentSessionContext {
	...
	private static final Class[] SESS_PROXY_INTERFACES = new Class[] {
			org.luceehibernate.classic.Session.class,
	        org.luceehibernate.engine.SessionImplementor.class,
	        org.luceehibernate.jdbc.JDBCContext.Context.class,
	        org.luceehibernate.event.EventSource.class
	};
	 ...
	 */
	public static void bind(org.luceehibernate.Session session) {
	...
	private static void doBind(org.luceehibernate.Session session, SessionFactory factory) {
		Map sessionMap = sessionMap();
		if ( sessionMap == null ) {
