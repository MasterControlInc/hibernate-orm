...
public final class Expression extends Restrictions {
	 ...
	 *
	 * @deprecated use {@link org.luceehibernate.criterion.Restrictions#sqlRestriction(String, Object[], Type[])}
	 * @param sql
	 * @param values
	 * @param types
	 * @return Criterion
	 ...
	 *
	 * @deprecated use {@link org.luceehibernate.criterion.Restrictions#sqlRestriction(String)}
	 * @param sql
	 * @return Criterion
	 */
