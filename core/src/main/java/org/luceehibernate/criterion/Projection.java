...
public interface Projection extends Serializable {
	 ...
	 * <p/>
	 * Differs from {@link #getTypes(org.luceehibernate.Criteria, CriteriaQuery)} in that here we are only interested in
	 ...
	 * {@link org.luceehibernate.transform.ResultTransformer})
	 *
	 * @return The aliases
	 */
