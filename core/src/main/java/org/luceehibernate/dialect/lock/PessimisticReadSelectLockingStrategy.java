 ...
 */
package org.luceehibernate.dialect.lock;
...
import org.luceehibernate.PessimisticLockException;
 ...
 * @author Scott Marlow
 * @see org.luceehibernate.dialect.Dialect#getForUpdateString(org.luceehibernate.LockMode)
 * @see org.luceehibernate.dialect.Dialect#appendLockHint(org.luceehibernate.LockMode, String)
 * @since 3.5
 */
public class PessimisticReadSelectLockingStrategy extends AbstractSelectLockingStrategy {
	...
	/**
	 * @see org.luceehibernate.dialect.lock.LockingStrategy#lock
	 */
	public void lock(
			Serializable id,
			Object version,
