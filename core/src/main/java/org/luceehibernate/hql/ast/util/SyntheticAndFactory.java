...
import org.luceehibernate.hql.ast.tree.Node;
import org.luceehibernate.hql.ast.HqlSqlWalker;
...
public class SyntheticAndFactory implements HqlSqlTokenTypes {
	...
	public void addWhereFragment(
		...
		// theta join node.  This is because org.luceehibernate.loader.Loader binds the filter parameters first,
		// then it binds all the HQL query parameters, see org.luceehibernate.loader.Loader.processFilterParameters().
