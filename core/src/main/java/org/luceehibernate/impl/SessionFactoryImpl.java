...
import org.luceehibernate.cache.QueryCache;
import org.luceehibernate.cache.Region;
import org.luceehibernate.cache.UpdateTimestampsCache;
...
import org.luceehibernate.cache.impl.CacheDataDescriptionImpl;
...
import org.luceehibernate.connection.ConnectionProvider;
import org.luceehibernate.context.CurrentSessionContext;
import org.luceehibernate.context.JTASessionContext;
import org.luceehibernate.context.ManagedSessionContext;
import org.luceehibernate.context.ThreadLocalSessionContext;
import org.luceehibernate.dialect.Dialect;
import org.luceehibernate.dialect.function.SQLFunctionRegistry;
import org.luceehibernate.engine.FilterDefinition;
import org.luceehibernate.engine.Mapping;
import org.luceehibernate.engine.NamedQueryDefinition;
import org.luceehibernate.engine.NamedSQLQueryDefinition;
import org.luceehibernate.engine.ResultSetMappingDefinition;
import org.luceehibernate.engine.SessionFactoryImplementor;
import org.luceehibernate.engine.profile.FetchProfile;
import org.luceehibernate.engine.profile.Fetch;
import org.luceehibernate.engine.profile.Association;
import org.luceehibernate.engine.query.QueryPlanCache;
import org.luceehibernate.engine.query.sql.NativeSQLQuerySpecification;
import org.luceehibernate.event.EventListeners;
import org.luceehibernate.exception.SQLExceptionConverter;
import org.luceehibernate.id.IdentifierGenerator;
import org.luceehibernate.id.UUIDHexGenerator;
import org.luceehibernate.id.factory.IdentifierGeneratorFactory;
import org.luceehibernate.jdbc.BatcherFactory;
import org.luceehibernate.mapping.Collection;
import org.luceehibernate.mapping.PersistentClass;
import org.luceehibernate.mapping.RootClass;
import org.luceehibernate.metadata.ClassMetadata;
import org.luceehibernate.metadata.CollectionMetadata;
import org.luceehibernate.persister.PersisterFactory;
...
import org.luceehibernate.persister.entity.Queryable;
import org.luceehibernate.persister.entity.Loadable;
import org.luceehibernate.pretty.MessageHelper;
import org.luceehibernate.proxy.EntityNotFoundDelegate;
import org.luceehibernate.stat.Statistics;
import org.luceehibernate.stat.StatisticsImpl;
import org.luceehibernate.stat.ConcurrentStatisticsImpl;
import org.luceehibernate.stat.StatisticsImplementor;
import org.luceehibernate.tool.hbm2ddl.SchemaExport;
import org.luceehibernate.tool.hbm2ddl.SchemaUpdate;
import org.luceehibernate.tool.hbm2ddl.SchemaValidator;
import org.luceehibernate.transaction.TransactionFactory;
import org.luceehibernate.type.AssociationType;
import org.luceehibernate.type.Type;
import org.luceehibernate.util.CollectionHelper;
import org.luceehibernate.util.ReflectHelper;
import org.luceehibernate.util.EmptyIterator;
 ...
 *
 * @see org.luceehibernate.connection.ConnectionProvider
 * @see org.luceehibernate.classic.Session
 * @see org.luceehibernate.hql.QueryTranslator
 * @see org.luceehibernate.persister.entity.EntityPersister
 * @see org.luceehibernate.persister.collection.CollectionPersister
 * @author Gavin King
 */
public final class SessionFactoryImpl implements SessionFactory, SessionFactoryImplementor {
	...
	public SessionFactoryImpl(
		...
		try {
			Class concurrentStatsClass = ReflectHelper.classForName("org.luceehibernate.stat.ConcurrentStatisticsImpl");
		...
		while ( itr.hasNext() ) {
			final org.luceehibernate.mapping.FetchProfile mappingProfile =
					( org.luceehibernate.mapping.FetchProfile ) itr.next();
			final FetchProfile fetchProfile = new FetchProfile( mappingProfile.getName() );
			Iterator fetches = mappingProfile.getFetches().iterator();
			while ( fetches.hasNext() ) {
				final org.luceehibernate.mapping.FetchProfile.Fetch mappingFetch =
						( org.luceehibernate.mapping.FetchProfile.Fetch ) fetches.next();
	...
	public org.luceehibernate.classic.Session openSession(Connection connection, Interceptor sessionLocalInterceptor) {
		return openSession(connection, false, Long.MIN_VALUE, sessionLocalInterceptor);
	}

	public org.luceehibernate.classic.Session openSession(Interceptor sessionLocalInterceptor)
	...
	public org.luceehibernate.classic.Session openSession(Connection connection) {
		return openSession(connection, interceptor); //prevents this session from adding things to cache
	}

	public org.luceehibernate.classic.Session openSession() throws HibernateException {
		return openSession(interceptor);
	}

	public org.luceehibernate.classic.Session openTemporarySession() throws HibernateException {
		return new SessionImpl(
				null,
		        this,
		        true,
	...
	public org.luceehibernate.classic.Session openSession(
	...
	public org.luceehibernate.classic.Session getCurrentSession() throws HibernateException {
