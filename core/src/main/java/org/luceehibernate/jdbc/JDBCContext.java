 ...
 *
 */
package org.luceehibernate.jdbc;
...
import org.luceehibernate.TransactionException;
import org.luceehibernate.util.JTAHelper;
import org.luceehibernate.engine.SessionFactoryImplementor;
import org.luceehibernate.exception.JDBCExceptionHelper;
import org.luceehibernate.transaction.CacheSynchronization;
...
public class JDBCContext implements Serializable, ConnectionManager.Callback {
	...
	public boolean registerSynchronizationIfPossible() {
		if ( isTransactionCallbackRegistered ) {
			...
			// (org.luceehibernate.Transaction) transaction has accepted
