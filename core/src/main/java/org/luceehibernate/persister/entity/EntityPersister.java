...
import org.luceehibernate.cache.OptimisticCacheSource;
 ...
 * matching the signature of: {@link org.luceehibernate.mapping.PersistentClass}, {@link org.luceehibernate.engine.SessionFactoryImplementor}
 *
 * @author Gavin King
 */
public interface EntityPersister extends OptimisticCacheSource {
	 ...
	 * <p/>
	 * Called only once per {@link org.luceehibernate.SessionFactory} lifecycle,
	 * after all entity persisters have been instantiated.
	 *
	 * @throws org.luceehibernate.MappingException Indicates an issue in the metadata.
	 */
	 ...
	 * the type.
	 * @return The type.
	 * @throws org.luceehibernate.MappingException Typically indicates an unknown
	 * property name.
	 */
	 ...
	 * {@link org.luceehibernate.engine.PersistenceContext}.
	 * <p/>
