 ...
 *
 */
package org.luceehibernate.proxy;
...
public interface LazyInitializer {
	 ...
	 * @see org.luceehibernate.proxy.LazyInitializer#isReadOnlySettingAvailable()
	 *
	 * @return true, if this proxy is read-only; false, otherwise
	 * @throws org.luceehibernate.TransientObjectException if the proxy is detached (getSession() == null)
	 * @throws org.luceehibernate.SessionException if the proxy is associated with a sesssion that is closed
	 *
	 * @see org.luceehibernate.Session#isReadOnly(Object entityOrProxy)
	 */
	 ...
	 * @throws org.luceehibernate.TransientObjectException if the proxy is not association with a session
	 * @throws org.luceehibernate.SessionException if the proxy is associated with a sesssion that is closed
	 * 
	 * @see org.luceehibernate.Session#setReadOnly(Object entityOrProxy, boolean readOnly)
	 */
	 ...
	 * <p/>
	 * Generally speaking this is intended to be called only during {@link org.luceehibernate.Session#evict} and
	 * {@link org.luceehibernate.Session#clear} processing; most other use-cases should call {@link #setSession} instead.
	 */
