 ...
 *
 */
package org.luceehibernate.transaction;
...
/**
 * A JTA transaction synch used to allow the {@link org.luceehibernate.Session} to know about transaction
 * events.
 *
 * @author Gavin King
 */
public final class CacheSynchronization implements Synchronization {
	...
	private final org.luceehibernate.Transaction hibernateTransaction;

	public CacheSynchronization(
			TransactionFactory.Context ctx, 
			JDBCContext jdbcContext, 
			Transaction transaction, 
			org.luceehibernate.Transaction tx) {
		this.ctx = ctx;
