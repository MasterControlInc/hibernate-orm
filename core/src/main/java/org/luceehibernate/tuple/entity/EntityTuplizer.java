 ...
 *      (org.luceehibernate.tuple.entity.EntityMetamodel, org.luceehibernate.mapping.PersistentClass)
 *
 * @author Gavin King
...
public interface EntityTuplizer extends Tuplizer {
	 ...
	 * the {@link org.luceehibernate.classic.Lifecycle} interface.
	 *
	...
	/**
	 * Does the {@link #getMappedClass() class} managed by this tuplizer implement
	 * the {@link org.luceehibernate.classic.Validatable} interface.
	 *
	 ...
	 * <p/>
	 * todo : look at fully encapsulating {@link org.luceehibernate.engine.PersistenceContext#narrowProxy} here,
