...
public class CurrencyType extends ImmutableType implements LiteralType {
	...
	/**
	 * @see org.luceehibernate.type.NullableType#get(ResultSet, String)
	 */
	...
	/**
	 * @see org.luceehibernate.type.NullableType#set(PreparedStatement, Object, int)
	 */
	...
	/**
	 * @see org.luceehibernate.type.NullableType#sqlType()
	 */
	public int sqlType() {
	...
	/**
	 * @see org.luceehibernate.type.Type#getReturnedClass()
	 */
	...
	/**
	 * @see org.luceehibernate.type.Type#getName()
	 */
	...
	/**
	 * @see org.luceehibernate.type.LiteralType#objectToSQLString(Object, Dialect)
	 */
