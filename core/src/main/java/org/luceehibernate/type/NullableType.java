...
import org.luceehibernate.util.EqualsHelper;
...
public abstract class NullableType extends AbstractType {
	 ...
	 * was controlled by the trace level enablement on the 'org.luceehibernate.type' package...
	 * <p/>
	 ...
	 *
	 * @throws org.luceehibernate.HibernateException Generally some form of mismatch error.
	...
	/**
	 * A convenience form of {@link #sqlTypes(org.luceehibernate.engine.Mapping)}, returning
