...
public final class StringHelper {
	 ...
	 * Imagine you have a class named <samp>'org.luceehibernate.util.StringHelper'</samp>; calling collapse on that
	...
	/**
	 * Partially unqualifies a qualified name.  For example, with a base of 'org.luceehibernate' the name
	 * 'org.luceehibernate.util.StringHelper' would become 'util.StringHelper'.
	 *
	 ...
	 * except that only the qualifierBase is collapsed.  For example, with a base of 'org.luceehibernate' the name
	 * 'org.luceehibernate.util.StringHelper' would become 'o.h.util.StringHelper'.
	 *
	 * @param name The (potentially) qualified name.
	 * @param qualifierBase The qualifier base.
	 *
	 ...
	 * <li>starts with dialect-specified {@link org.luceehibernate.dialect.Dialect#openQuote() open-quote}
	 * 		AND ends with dialect-specified {@link org.luceehibernate.dialect.Dialect#closeQuote() close-quote}</li>
	 * </ol>
	 *
	 * @param name The name to check
